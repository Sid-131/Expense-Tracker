...
from app.api.v1 import auth, users, groups, expenses, settlements, personal_expenses
...
router.include_router(personal_expenses.router, prefix="/personal-expenses", tags=["personal"])
